...
//Determine if a given object is a number
XML.ObjTree.prototype.isNumber = function(num) {
...
// SMC Customization: Begin - Required to fix document parsing issues
XML.ObjTree.prototype.rootBegin = '<root>\n';
XML.ObjTree.prototype.rootEnd = '</root>\n';
// SMC Customization: End - Required to fix document parsing issues
...
XML.ObjTree.prototype.writeXML = function ( tree ) {
    ...
    return this.xmlDecl + this.rootBegin + xml + this.rootEnd;
};
...
XML.ObjTree.prototype.array_to_xml = function ( name, array ) {
    var out = [];
    // SMC Customization: Hack to work Arrays
    name = name.replace(" ","-");
    name = name.replace(":","-");
    // SMC Customization: Hack to work Arrays
