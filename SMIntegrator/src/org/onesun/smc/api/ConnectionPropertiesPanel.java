...
public abstract class ConnectionPropertiesPanel extends JPanel implements ConnectionPropertiesView, Cloneable {
	/**
	 * 
	 */
	...
	protected ConnectionPropertiesPanel rootPanel = this;
	...
	@Override
	public ConnectionPropertiesPanel getView() {
		return this;
	}

	@Override
	public abstract void updateFields(ConnectionProperties properties);
