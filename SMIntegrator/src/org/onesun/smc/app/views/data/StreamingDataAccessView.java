...
import org.onesun.smc.core.services.streaming.StreamingListener;

public class StreamingDataAccessView extends AbstractDataAccessView {
	/**
	 * 
	 */
	...
	public StreamingDataAccessView(){
		super();
		
		validateButton.setText(START_SAMPLING_LABEL);
	}
	
	private StreamingListener executor = new StreamingListener(
			new DataHandler() {
				@Override
