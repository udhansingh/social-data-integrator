...
public class TwitterStreamingConnectorView extends ConnectorPanel {
	/**
	 * 
	 */
	...
	public TwitterStreamingConnectorView(){
		super();
		onInitComplete();
	}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null) || connectionName.isEmpty()){
							...
							TwitterStreamingConnector connection = new TwitterStreamingConnector();
	...
	public void updateFields(Connector connector) {
		if(connector instanceof TwitterStreamingConnector){
			TwitterStreamingConnector connection = (TwitterStreamingConnector)connector;
