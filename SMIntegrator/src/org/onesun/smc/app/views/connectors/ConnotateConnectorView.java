...
public class ConnotateConnectorView extends ConnectorPanel {
	/**
	 * 
	 */
	...
	public void updateFields(Connector connector) {
		if(connector instanceof ConnotateConnector){
			ConnotateConnector connection = (ConnotateConnector)connector;
