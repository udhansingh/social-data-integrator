...
public class SocialMediaConnectorView extends ConnectorPanel {
	private static Logger logger = Logger.getLogger(SocialMediaConnectorView.class);
	...
	public SocialMediaConnectorView(){
		super();
		onInitComplete();
	}
	...
	public void updateFields(Connector connector) {
		if(connector instanceof SocialMediaConnector){
			SocialMediaConnector connection = (SocialMediaConnector)connector;
