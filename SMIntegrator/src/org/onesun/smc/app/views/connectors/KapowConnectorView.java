...
public class KapowConnectorView extends ConnectorPanel {
	/**
	 * 
	 */
	...
	public void updateFields(Connector connector) {
		if(connector instanceof KapowConnector){
			KapowConnector connection = (KapowConnector)connector;
