...
public class FacebookStreamingConnectorView extends ConnectorPanel {
	/**
	 * 
	 */
	...
	public FacebookStreamingConnectorView(){
		super();
		onInitComplete();
	}
	...
	public void updateFields(Connector connector) {
		if(connector instanceof FacebookStreamingConnector){
			FacebookStreamingConnector connection = (FacebookStreamingConnector)connector;
