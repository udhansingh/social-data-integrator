...
public class FileConnectionPropertiesView extends ConnectionPropertiesPanel {
	/**
	 * 
	 */
	...
	public FileConnectionPropertiesView(){
		super();
		onInitComplete();
	}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null && path == null) || connectionName.isEmpty()){
							...
							FileSystemConnectionProperties connection = new FileSystemConnectionProperties();
	...
	public void updateFields(ConnectionProperties connector) {
		if(connector instanceof FileSystemConnectionProperties){
			FileSystemConnectionProperties connection = (FileSystemConnectionProperties)connector;
