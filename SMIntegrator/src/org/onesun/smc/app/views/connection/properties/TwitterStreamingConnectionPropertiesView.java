...
public class TwitterStreamingConnectionPropertiesView extends ConnectionPropertiesPanel {
	/**
	 * 
	 */
	...
	public TwitterStreamingConnectionPropertiesView(){
		super();
		onInitComplete();
	}
	...
	@Override
	public void init(){
		identityComboBox.addItem("Twitter Streaming");
	}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null) || connectionName.isEmpty()){
							...
							TwitterStreamingConnectionProperties connection = new TwitterStreamingConnectionProperties();
							connection.setName(connectionName);
							connection.setUsername(username);
							connection.setPassword(password);
							connection.setIdentity("Twitter Streaming");
	...
	public void updateFields(ConnectionProperties connector) {
		if(connector instanceof TwitterStreamingConnectionProperties){
			TwitterStreamingConnectionProperties connection = (TwitterStreamingConnectionProperties)connector;
			...
			// update UI bindings
			StreamingProvider entry = (StreamingProvider)ProviderFactory.getProvider(provider.toLowerCase(), "TWITTER_STREAMING");
