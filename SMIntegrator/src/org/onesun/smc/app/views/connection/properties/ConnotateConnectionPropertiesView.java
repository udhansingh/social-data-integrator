...
public class ConnotateConnectionPropertiesView extends ConnectionPropertiesPanel {
	/**
	 * 
	 */
	...
	public ConnotateConnectionPropertiesView(){
		super();
		onInitComplete();
	}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null && url == null) || connectionName.isEmpty()){
							...
							ConnotateConnectionProperties connection = new ConnotateConnectionProperties();
	...
	public void updateFields(ConnectionProperties connector) {
		if(connector instanceof ConnotateConnectionProperties){
			ConnotateConnectionProperties connection = (ConnotateConnectionProperties)connector;
