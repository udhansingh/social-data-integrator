...
public class FacebookProvider extends AbstractSocialMediaProvider {
	...
	public void init() {
		...
		RESTResource[] resourceArray = {
			// Unauthenticated
			new RESTResource("Search-Post",		true,	"https://graph.facebook.com/search?type=POST"),
			new RESTResource("Search-User",		true,	"https://graph.facebook.com/search?type=USER"),
			new RESTResource("Search-Page",		true,	"https://graph.facebook.com/search?type=PAGE"),
			new RESTResource("Search-Event",	true,	"https://graph.facebook.com/search?type=EVENT"),
			new RESTResource("Search-Group",	true,	"https://graph.facebook.com/search?type=GROUP"),
			new RESTResource("Search-Place",	true,	"https://graph.facebook.com/search?type=PLACE"),
			new RESTResource("Search-Checkin",	true,	"https://graph.facebook.com/search?type=CHECKIN"),
