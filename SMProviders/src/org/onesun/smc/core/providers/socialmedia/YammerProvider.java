...
public class YammerProvider extends AbstractSocialMediaProvider {
	@Override
	public void init() {
		...
		this.developerUrl = "https://www.yammer.com/client_applications";
		this.apiClass = org.scribe.builder.api.YammerApi.class;
