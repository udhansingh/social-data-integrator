...
public class StreamingListener {
	...
	private TwitterStreamingConnector connection = null;
	...
	public StreamingListener(DataHandler datahandler, ConnectionHandler connectionHandler){
	...
	public void setConnection(TwitterStreamingConnector connection) {
