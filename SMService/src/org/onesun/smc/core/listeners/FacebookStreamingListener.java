...
public class FacebookStreamingListener {
	private static Logger logger = Logger.getLogger(FacebookStreamingListener.class);
...
//	private static final String SUBSCRIBE_CONTEXT = "/facebook/subscribe";
	...
	public static void setTimeout(int timeout) {
		FacebookStreamingListener.timeout = timeout;
	}
...
//		});
	...
	public static void main(String[] args){
		FacebookStreamingListener frc = new FacebookStreamingListener();
		frc.start();
	}
