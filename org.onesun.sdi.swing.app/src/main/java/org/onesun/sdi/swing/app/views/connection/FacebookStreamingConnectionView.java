...
public class FacebookStreamingConnectionView extends ConnectionViewPanel {
	/**
	 * 
	 */
	...
	public FacebookStreamingConnectionView(){
		super();
		onInitComplete();
	}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null) || connectionName.isEmpty()){
							...
							FacebookStreamingConnection connection = new FacebookStreamingConnection();
	...
	public void updateFields(Connection connector) {
		if(connector instanceof FacebookStreamingConnection){
			FacebookStreamingConnection connection = (FacebookStreamingConnection)connector;
