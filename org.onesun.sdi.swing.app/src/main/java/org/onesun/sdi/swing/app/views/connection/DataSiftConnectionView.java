...
public class DataSiftConnectionView extends ConnectionViewPanel {
	/**
	 * 
	 */
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null && username == null) || connectionName.isEmpty()){
							...
							DataSiftConnection connection = new DataSiftConnection();
	...
	public void updateFields(Connection connector) {
		if(connector instanceof DataSiftConnection){
			DataSiftConnection connection = (DataSiftConnection)connector;
