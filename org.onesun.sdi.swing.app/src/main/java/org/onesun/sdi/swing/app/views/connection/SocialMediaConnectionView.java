...
public class SocialMediaConnectionView extends ConnectionViewPanel {
	private static Logger logger = Logger.getLogger(SocialMediaConnectionView.class);
	...
	public SocialMediaConnectionView(){
		super();
		onInitComplete();
	}
	...
	public void updateFields(Connection connector) {
		if(connector instanceof OAuthConnection){
			OAuthConnection connection = (OAuthConnection)connector;
