...
import org.onesun.sdi.core.metadata.FacetedMetadata;
import org.onesun.sdi.core.metadata.FilterMetadata;
import org.onesun.sdi.core.metadata.JSONMetadataReader;
import org.onesun.sdi.core.metadata.MasterMetadataMerger;
...
import org.onesun.sdi.swing.app.api.DataPreviewer;
import org.onesun.sdi.swing.app.model.MetadataTableModel;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(cp.getCategory().compareTo("KAPOW") == 0){
					...
					for(String facet : facets){
						...
						Metadata m = facetedMetadata.getMetadata(facet);
						GnipConnection gcp = (GnipConnection)cp;
						m.setUrl(gcp.getUrl());
						m.setVerb("GET");
					}
