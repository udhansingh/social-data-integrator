...
public class KapowConnectionView extends ConnectionViewPanel {
	/**
	 * 
	 */
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null && url == null) || connectionName.isEmpty()){
							...
							KapowConnection connection = new KapowConnection();
	...
	public void updateFields(Connection connector) {
		if(connector instanceof KapowConnection){
			KapowConnection connection = (KapowConnection)connector;
