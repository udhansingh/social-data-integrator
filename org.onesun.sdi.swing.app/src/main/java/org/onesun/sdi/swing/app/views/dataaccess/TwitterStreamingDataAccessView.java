...
import org.onesun.sdi.sil.client.TwitterStreamingClient;
		...
		validateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				if(validateButton.getText().compareTo(START_SAMPLING_LABEL) == 0){
					...
					executor.setConnectionProperties((TwitterStreamingConnection) AppCommons.TASKLET.getConnectionProperties());
