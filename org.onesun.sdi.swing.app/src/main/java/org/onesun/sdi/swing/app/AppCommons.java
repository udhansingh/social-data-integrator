...
import org.onesun.sdi.core.api.ConfigurationHelper;
import org.onesun.sdi.core.api.ConnectionsFactory;
import org.onesun.sdi.core.api.DataTypeFactory;
import org.onesun.sdi.core.api.ProxyConfiguration;
import org.onesun.sdi.core.model.Tasklet;
import org.onesun.sdi.core.tools.ProxyAuthenticator;
import org.onesun.sdi.sil.api.DataServicesFactory;
import org.onesun.sdi.sil.auth.OAuthenticator;
import org.onesun.sdi.spi.api.FilterFactory;
...
import org.onesun.sdi.swing.app.api.TaskletsFactory;
...
public class AppCommons {
	...
	public static String 								OAUTH_CALLBACK_SERVER_CONTEXT		= "/ows/jrs/callback";
	...
	public static void init() {
		...
		if(ALL_FEATURES_ENABLED || isFeatureEnabled(FEATURE_CONNECTIVITY)){
			ConnectionsFactory.load(PATH_TO_CORE + "connection-properties.xml");
			ConnectionsFactory.loadConnection(PATH_TO_CONNECTIONS);
			ConnectionViewsFactory.load(PATH_TO_CORE + "connection-properties-views.xml");
