...
public class TwitterStreamingConnectionView extends ConnectionViewPanel {
	/**
	 * 
	 */
	...
	public TwitterStreamingConnectionView(){
		super();
		onInitComplete();
	}
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						if((connectionName == null) || connectionName.isEmpty()){
							...
							TwitterStreamingConnection connection = new TwitterStreamingConnection();
	...
	public void updateFields(Connection connector) {
		if(connector instanceof TwitterStreamingConnection){
			TwitterStreamingConnection connection = (TwitterStreamingConnection)connector;
