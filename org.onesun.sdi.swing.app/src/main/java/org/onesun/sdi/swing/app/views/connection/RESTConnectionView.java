...
public class RESTConnectionView extends ConnectionViewPanel {
	/**
	 * 
	 */
	...
	public void updateFields(Connection connector) {
		if(connector instanceof RESTConnection){
			RESTConnection connection = (RESTConnection)connector;
