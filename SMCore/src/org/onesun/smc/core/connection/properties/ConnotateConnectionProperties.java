...
public class ConnotateConnectionProperties extends WebConnectionProperties {
	private static Logger logger = Logger.getLogger(ConnotateConnectionProperties.class);
	
	public ConnotateConnectionProperties(){
