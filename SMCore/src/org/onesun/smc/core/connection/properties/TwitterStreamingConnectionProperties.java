...
public class TwitterStreamingConnectionProperties extends RESTConnectionProperties {
	private static Logger logger = Logger.getLogger(TwitterStreamingConnectionProperties.class);
	
	public TwitterStreamingConnectionProperties(){
		super("Twitter Streaming", "TWITTER_STREAMING", "TWITTER_STREAMING");
	}
