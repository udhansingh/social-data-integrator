...
public class FacebookStreamingConnectionProperties extends RESTConnectionProperties {
	private static Logger logger = Logger.getLogger(FacebookStreamingConnectionProperties.class);
	
	public FacebookStreamingConnectionProperties(){
		super("Facebook Streaming", "FACEBOOK_STREAMING", "FACEBOOK_STREAMING");
	}
	...
	public void save(String path) throws FileNotFoundException, IOException {
		...
		properties.store(fos, "Facebook Streaming Connection Properties");
