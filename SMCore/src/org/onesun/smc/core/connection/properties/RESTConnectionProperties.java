...
public class RESTConnectionProperties extends AbstractConnectionProperties {
	private static Logger logger = Logger.getLogger(RESTConnectionProperties.class);
			
	protected String username = null;
	protected String password = null;
	
	public RESTConnectionProperties(){
		super("General", "GENERAL", "REST");
	}
	
	protected RESTConnectionProperties(String identity, String category, String authentication) {
