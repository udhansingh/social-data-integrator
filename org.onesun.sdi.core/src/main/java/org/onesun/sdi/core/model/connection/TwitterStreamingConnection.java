...
public class TwitterStreamingConnection extends RESTConnection {
	private static Logger logger = Logger.getLogger(TwitterStreamingConnection.class);
	
	public TwitterStreamingConnection(){
