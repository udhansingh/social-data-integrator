...
public class FacebookStreamingConnection extends RESTConnection {
	private static Logger logger = Logger.getLogger(FacebookStreamingConnection.class);
	
	public FacebookStreamingConnection(){
